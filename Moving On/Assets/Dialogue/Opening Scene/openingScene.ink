...
+ [...اگه بتونم]
    ...
    .هم که شده باهم این مشکل رو رفع کنیم #speaker: Mom
    ~ ready = false
    ~ is_ready = ready
    -> DONE

+ [حتما‌ً]
    !مرسی عزیزم، پاشو بریم #speaker: Mom
    ~ ready = true
    ~ is_ready = ready
    -> DONE
...
「いやいや、そんな、。。。気のせいだろう、まだ夢見ているのだろうね。。。そうよ！まだ夢見てる。目を覚めるために自分をつねらなけないだろう...。そういうものだろう？」
